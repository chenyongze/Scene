...
class Debug
{
    ...
    */
    ...
    public function getMajorVersion() -> string
    {
        ...
        let parts = explode(" ", \Scene\Version::get());
        return parts[0];
    }
    ...
    {
        return "<div class=\"version\">Scene Framework <a target=\"_new\" href=\"//scene.ainstant.com/" .
            this->getMajorVersion() . "/\">" .
            \Scene\Version::get() . "</a></div>";
    }
    ...
    protected final function showTraceItem(int n, array! trace)
    {
        ...
        if fetch className, trace["class"] {
            ...
            /**
             * We assume that classes starting by Scene are framework's classes
             */
            if preg_match("/^Scene/", className) {

                /**
                 * Prepare the class name according to the Scene's conventions
                 */
